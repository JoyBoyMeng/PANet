...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--dataset_name', type=str, help='dataset to be used', default='wikipedia',
                        choices=['wikipedia', 'reddit', 'mooc', 'lastfm', 'myket', 'enron', 'SocialEvo', 'uci', 'Flights', 'CanParl', 'USLegis', 'UNtrade', 'UNvote', 'Contacts', 'yelp', 'aminer', 'aps', 'pet', 'game', 'clothing'])
    parser.add_argument('--batch_size', type=int, default=200, help='batch size')
    parser.add_argument('--model_name', type=str, default='DyConnect', help='name of the model, note that EdgeBank is only applicable for evaluation',
                        choices=['JODIE', 'DyRep', 'TGAT', 'TGN', 'CAWN', 'EdgeBank', 'TCL', 'GraphMixer', 'DyGFormer', 'DyConNet'])
    ...
    parser.add_argument('--window_size', type=int, default=10000, help='CSR window size')
    parser.add_argument('--order1_neighbor_nums', type=int, default=50, help='Retain the Top K Strongest Connected Neighbors of the 1st Order')
    parser.add_argument('--order2_neighbor_nums', type=int, default=50, help='Retain the Top K Strongest Connected Neighbors of the 2st Order')
    parser.add_argument('--order3_neighbor_nums', type=int, default=50, help='Retain the Top K Strongest Connected Neighbors of the 3st Order')
    parser.add_argument('--neighbor_order_range', type=int, default=3, help='The Range of the Neighbor Orders')
    parser.add_argument('--relation_order', type=int, default=5, help='The Range of the Compute Orders')
    parser.add_argument('--bi', action='store_true', default=False, help='if graph is bigraph')
    parser.add_argument('--matrix_on_gpu', action='store_true', default=False, help='Whether the sparse matrix uses GPU computation')
    ...
    assert args.relation_order >= args.neighbor_order_range, 'The Range of the Compute Orders can not be less than The Range of the Neighbor Orders'
